...
export type FeaturedProductsSectionQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  type: StorefrontAPI.Scalars['String']['input'];
}>;

export type FeaturedProductsSectionQuery = {
  metaobject?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metaobject, 'id'> & {
      fields: Array<
        Pick<StorefrontAPI.MetaobjectField, 'key' | 'value'> & {
          references?: StorefrontAPI.Maybe<{
            nodes: Array<
              Pick<
                StorefrontAPI.Product,
                'id' | 'createdAt' | 'handle' | 'description' | 'title'
              > & {
                priceRange: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query FeaturedProductsSection($handle: String!, $type: String!) {\n    metaobject(handle: {handle: $handle, type: $type}) {\n      id\n      fields {\n        key\n        value\n        references(first: 10) {\n          nodes {\n            ... on Product {\n              id\n              createdAt\n              handle\n              description\n              title\n              priceRange {\n                maxVariantPrice {\n                  amount\n                  currencyCode\n                }\n              }\n              images(first: 10) {\n                nodes {\n                  url\n                  width\n                  altText\n                  height\n                  id\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: FeaturedProductsSectionQuery;
    variables: FeaturedProductsSectionQueryVariables;
  };
